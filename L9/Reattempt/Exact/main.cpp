...
void GreekA(map<string, double> b)
{
    ...
    cout << "Gamma: " << e.getGamma() << endl;
}

void dividedDifference(map<string, double> b, double h)
{
    European e(
        b["S"],
        b["K"],
    ...
    cout << "Divided Difference Delta Call Approx: " << e.dividedDifferenceDelta(h, "call") << endl;
    cout << "Divided Difference Delta Put Approx: " << e.dividedDifferenceDelta(h, "put") << endl;
    cout << "Divided Difference Gamma Approx: " << e.dividedDifferenceGamma(h) << endl;
}

void perpetualAmerican(map<string, double> b)
{
    PerpetualAmerican e(
        b["S"],
        b["K"],
...
int main()
{
    ...
    cout << "=====GREEKS=====" << endl;
    GreekA(batches::s1);
    dividedDifference(batches::s1, 0.5);

    cout << "\nB. PERPETUAL AMERICAN OPTIONS" << endl;
    perpetualAmerican(batches::a1);
}